    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        currentLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Activity settingsActivity = (com.example.android.sunshine.app.SettingsActivity) context;
                try {
                    settingsActivity.startActivityForResult(
                            builder.build((Activity) context), com.example.android.sunshine.app.SettingsActivity.PLACE_PICKER_REQUEST);
